...
#SBATCH --job-name=bowtie2_mapping_blood
...
# Defines input, output and index paths
INPUT_DIR=/path/to/your_directory/trypanosomes/trim_galore/blood
OUTPUT_DIR=/path/to/your_directory/trypanosomes/mapping_bowtie2/sam_files_blood
