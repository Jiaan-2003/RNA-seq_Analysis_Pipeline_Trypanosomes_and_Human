...
#SBATCH --job-name=htseq_in_vitro
...
INPUT_DIR=/path/to/your_directory/trypanosomes/mapping_bowtie2/bam_files/in_vitro/sorted
OUTPUT_DIR=/path/to/your_directory/trypanosomes/htseq/in_vitro
