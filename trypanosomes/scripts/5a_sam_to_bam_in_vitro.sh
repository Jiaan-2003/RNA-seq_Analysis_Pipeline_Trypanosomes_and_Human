...
#SBATCH --job-name=sam_to_bam_in_vitro
...
INPUT_DIR=/path/to/your_directory/trypanosomes/mapping_bowtie2/sam_files_in_vitro
OUTPUT_DIR=/path/to/your_directory/trypanosomes/mapping_bowtie2/bam_files/in_vitro
SORTED_DIR=/path/to/your_directory/trypanosomes/mapping_bowtie2/bam_files/in_vitro/sorted
