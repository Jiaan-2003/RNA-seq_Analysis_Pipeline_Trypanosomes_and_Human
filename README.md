...
The Trypanosoma brucei reference genome and annotation files were obtained from TriTrypDB (release 68) and can be downloaded [here](https://tritrypdb.org/tritrypdb/app/downloads). These files are not available in this repository under “trypanosomes/reference_files” as their file size is too large (8.8M and 35M). Before running the trypanosomes part of the pipeline, ensure “TriTrypDB-68_TbruceiTREU927.gff” and “TriTrypDB-68_TbruceiTREU927.fasta” have been downloaded, and ideally placed into the reference files directory in the trypanosomes directory.
